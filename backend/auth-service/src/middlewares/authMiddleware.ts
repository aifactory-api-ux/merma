...
import { verifyToken, JsonWebTokenError } from '@merma/shared/auth.js';
import { UserSummary, UserRole } from '@merma/shared/models.js';
...
export function authMiddleware(
  ...
  try {
    ...
    try {
      ...
      // Handle other errors (e.g., missing secret)
      res.status(401).json({
        error: 'Unauthorized',
