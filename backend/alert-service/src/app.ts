/**
 * Merma Project - Alert Service
 * 
 * Express application for alert service.
 * Provides alerts and notifications for inventory management.
 * 
 * Version: 1.0.0
 */
...
// Import routes
import alertRoutes from './routes/alerts.js.js';
